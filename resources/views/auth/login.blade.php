            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('login.submit') }}" id="loginForm" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        @error('email')
                            <div class="field-error"
                                style="color: #dc3545; font-size: 12px; margin-top: 6px; padding-left: 10px; font-weight: 500;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <i class="fas fa-eye" id="togglePassword"
                                style="position: absolute; right: 18px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--primary); opacity: 0.6; z-index: 10;"></i>
                        </div>
                        @error('password')
                            <div class="field-error"
                                style="color: #dc3545; font-size: 12px; margin-top: 6px; padding-left: 10px; font-weight: 500;">
                    ...
                    <div class="remember-flex"
                        style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; font-size: 0.85rem;">
                        <label class="remember-label"
                            style="display: flex; align-items: center; gap: 8px; color: #666; cursor: pointer;">
                            <input type="checkbox" name="remember" style="accent-color: var(--primary);">
                            <span>Keep me logged in</span>
                        </label>
                        <a href="{{ route('password.request') }}" class="forgot-link"
                            style="color: var(--primary); font-weight: 700; text-decoration: none;">Forgot Password?</a>
                    </div>
                ...
                <div class="auth-footer" style="margin-top: 25px; text-align: center; color: #666; font-size: 0.9rem;">
                    Don't have an account? <a href="{{ route('register') }}"
                        style="color: var(--primary); font-weight: 700; text-decoration: none; border-bottom: 2px solid rgba(0, 66, 0, 0.1);">Create
                        Account</a>
                </div>
            </div>
        </div>
