            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('register.submit') }}" id="registerForm" novalidate>
                    ...
                    <div class="form-group">
                        <label class="form-label">Full Name<span class="text-danger"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="phone" id="reg_phone" class="form-input"
                                placeholder="Enter your phone number" value="{{ old('phone') }}" required autocomplete="tel"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <i class="fas fa-eye toggle-password" data-target="password"
                                    style="position: absolute; right: 18px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--primary-color); opacity: 0.6; z-index: 10;"></i>
                            </div>
                            @error('password')
                                <div class="field-error"
                                    style="color: #dc3545; font-size: 12px; margin-top: 6px; padding-left: 10px; font-weight: 500;">
                ...
                <div class="auth-footer" style="margin-top: 25px; text-align: center; color: #666; font-size: 0.9rem;">
                    Already have an account? <a href="{{ route('login') }}"
                        style="color: var(--primary); font-weight: 700; text-decoration: none; border-bottom: 2px solid rgba(0, 66, 0, 0.1);">Sign
                        In</a>
                </div>
            </div>
        </div>
