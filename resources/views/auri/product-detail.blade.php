                    ...
                    <div class="main-img-luxury">
                        ...
                        <div class="wishlist-overlay-badge-detail"
                            ...
                            <form action="{{ route('wishlist.toggle') }}" method="POST" class="wishlist-overlay-form">
                                ...
                                <button type="submit"
                                    style="width: 50px; height: 50px; border-radius: 50%; background: #fff; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15); cursor: pointer; display: flex; align-items: center; justify-content: center; color: {{ $isInWishlist ? '#d4145a' : 'var(--primary)' }}; transition: all 0.3s ease; font-size: 1.4rem;">
                ...
                <div class="info-luxury">
                    ...
                    <div class="luxury-price-card"
                        ...
                        <div class="price-badges"
                            ...
                            <span style="color: #666; font-size: 0.85rem; display: flex; align-items: center; gap: 8px;"><i
                                    class="fas fa-flask" style="color: #81c784;"></i> Lab Tested</span>
                        </div>
                    </div>
                    ...
                    <div class="luxury-actions">
                        <form action="{{ route('cart.add') }}" method="POST" id="product-form">
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px;">
                                <label
                                    style="font-weight: 700; color: var(--primary); text-transform: uppercase; font-size: 12px; letter-spacing: 1px;">Quantity:</label>
                        ...
                        <div class="contact-buttons-luxury" style="margin-top: 20px;">
                            <a href="https://wa.me/919818299669?text=I'm interested in {{ urlencode($product->name) }}"
                                target="_blank" class="btn-lx-outline"><i class="fab fa-whatsapp"></i> WhatsApp Inquiry</a>
                            <a href="tel:+919818299669" class="btn-lx-outline"><i class="fas fa-phone-alt"></i> Consultation
                                Call</a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="benefits-glass-grid">
                    <div class="glass-card">
                        ...
                        <p>Restores your natural energy balance and strengthens the immune system through potent botanical
                            extracts.</p>
                    </div>
                    <div class="glass-card">
                        <div class="glass-icon"><i class="fas fa-spa"></i></div>
                        <h3>Deep Calm</h3>
                        <p>Infused with meditative herbs that soothe the nervous system and promote restorative mental
                            peace.</p>
                    </div>
                    <div class="glass-card">
                        <div class="glass-icon"><i class="fas fa-feather-alt"></i></div>
                        <h3>Pure Detox</h3>
                        <p>Gently flushes out environmental toxins, leaving your body feeling light, clean, and rejuvenated.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="tabs-luxury-sec">
            <div class="container">
                <div class="lx-tabs-header">
                    ...
                    @endif
                    <button class="lx-tab-btn" onclick="switchLxTab(this, 'lx-reviews')">Reviews
                        ({{ $product->reviews->count() ?? 0 }})</button>
                </div>
                    ...
                    <div id="lx-reviews" class="lx-content-pane">
                        <div style="display: grid; grid-template-columns: 1fr 350px; gap: 40px; align-items: start;">
                            ...
                            <div>
                                ...
                                @if($product->reviews && $product->reviews->count())
                                    <div style="display: grid; gap: 20px;">
                                        @foreach($product->reviews as $review)
                                            <div
                                                style="padding: 25px; border-radius: 20px; border: 1px solid #f0f0f0; background: #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.02);">
                                                <div
                                                    style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                                    <div style="display: flex; align-items: center; gap: 12px;">
                                                        <div
                                                            style="width: 40px; height: 40px; border-radius: 50%; background: #e8f5e9; color: #2e7d32; display: flex; align-items: center; justify-content: center; font-weight: 700;">
                                ...
                                @else
                                    <div
                                        style="padding: 60px 20px; text-align: center; background: #fdfdfd; border-radius: 20px; border: 1px dashed #ddd;">
                                        <i class="far fa-comment-dots"
                                            style="font-size: 3rem; color: #ccc; margin-bottom: 20px;"></i>
                                        <p style="color: #888; font-size: 1rem;">Be the first to share your journey with this
                                            remedy.</p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="review-form-sticky"
                                style="position: sticky; top: 100px; background: #f9fbf9; padding: 30px; border-radius: 25px; border: 1px solid rgba(0,66,0,0.08);">
                                @auth
                                    <h5 style="font-size: 1.25rem; margin-bottom: 20px; color: #004200;">Share Your Thoughts
                                    </h5>
                                    <form action="{{ route('product.review.store', $product->slug) }}" method="POST">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <label
                                                style="display: block; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; color: #666; margin-bottom: 10px;">Your
                                                Rating</label>
                                            <div class="star-rating"
                                                style="display: flex; gap: 8px; font-size: 1.5rem; color: #ddd; cursor: pointer;">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <label
                                                style="display: block; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; color: #666; margin-bottom: 10px;">Experience
                                                Details</label>
                                            <textarea name="comment" rows="4"
                                                style="width: 100%; border-radius: 15px; border: 1px solid #ddd; padding: 15px; font-family: inherit; font-size: 0.9rem; resize: none; background: #fff;"
                                                placeholder="How did this product help you?" required></textarea>
                                        </div>

                                        <button type="submit"
                                            style="width: 100%; border: none; padding: 15px; border-radius: 50px; font-weight: 700; letter-spacing: 1px; background: #004200; color: #fff; cursor: pointer; transition: transform 0.2s ease;">SUBMIT
                                            REVIEW</button>
                                    </form>
                                @else
                                    <div style="text-align: center;">
                                        <div
                                            style="width: 60px; height: 60px; background: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; box-shadow: 0 10px 20px rgba(0,0,0,0.05);">
                                            <i class="fas fa-lock" style="color: #004200;"></i>
                                        </div>
                                        <h5 style="font-size: 1.2rem; margin-bottom: 10px;">Want to review this?</h5>
                                        <p style="font-size: 0.85rem; color: #666; margin-bottom: 25px;">Please login to your
                                            account to share your experience with others.</p>
                                        <a href="{{ route('login') }}"
                                            style="display: block; text-decoration: none; padding: 15px; border-radius: 50px; font-weight: 700; letter-spacing: 1px; background: #004200; color: #fff;">LOGIN
                                            TO REVIEW</a>
                                    </div>
                                @endauth
                            </div>
            ...
            <section class="related-lx-sec">
                <div class="container">
                    <div class="lx-sec-header-flex">
                        ...
                        <a href="{{ route('shop') }}" class="lx-link">Explore Collection <i
