...
@section('content')
    ...
    <section class="contact-hero">
        <div class="container hero-inner" style="text-align: center;">
            ...
            <h1 class="sec-title">Connect with Auvriplus</h1>
            <p class="p-text" style="max-width: 800px; margin: 0 auto;">Have questions about our Ayurvedic remedies or need personalized advice? Our team is here to help you on your wellness journey.</p>
        </div>
    </section>
