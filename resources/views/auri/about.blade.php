    ...
    <section class="about-hero-sec"
        ...
        <div class="container hero-inner" style="max-width: 900px; margin: 0 auto; position: relative; z-index: 2;">
            <span class="sub-title"
                ...
                TRADITION</span>
            <h1 class="sec-title" style="font-size: 4rem; line-height: 1.1; margin-bottom: 25px;">Authenticity & Tradition
            </h1>
            <p class="p-text" style="font-size: 1.2rem; line-height: 1.7; opacity: 0.95; margin: 0 auto;">Going way back to
                the ancient times, and infusing that wisdom to the present-day culture, is where we come from. Auvriplus is
                the best brand in the combination of authenticity and tradition to give the best products for Hair
                Care.<br>Our foundations come from the ancient ayurvedic scriptures and science.</p>
        </div>
    </section>
            ...
            <div class="about-split">
                ...
                <div class="split-info">
                    <div class="story-block">
                        <p class="p-text">We believe in the creation of the universe from the five basic elements, commonly
                            known as <strong>Panchabuthaas</strong>. Every cell of a human is built from the elements of
                            nature, a phenomenon familiarly known as <em>"Indriya Pancha Panchakas"</em>.</p>
                        <p class="p-text">Auvriplus treasures the secrets of our ancestors, bringing them to life through
                            modern-day supplements and products that holistically care for your skin, body, and hair.</p>
                    </div>
                    <div class="highlight-box">
                        <p class="p-text" style="font-weight: 600; font-style: italic; color: #004200; margin: 0;">
                            "Secrets of ancient health rituals, brought to life through pain-staking research for the
                            modern-day customer."
                        </p>
                    </div>
                </div>
    ...
    <section class="advanced-philosophy-sec">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p class="p-text" style="margin: 0 auto; opacity: 0.9;">Auvriplus bridges tradition and modern living
                    through the harmony of Panchabuthas and the five senses.</p>
            </div>

            <div class="pancha-wrapper"
                style="display: flex; align-items: center; justify-content: center; gap: 50px; flex-wrap: wrap;">
                <div class="radial-container">
                    ...
                    <div class="radial-centerpiece orbit-animation">
                        ...
                        <div class="radial-node node-air" data-element="Air"
                            data-info="Designed to deliver softness and purity, every formulation reflects the gentle element of air.">
                            <i class="fas fa-wind"></i>
                            <span>Air</span>
                        </div>
                        <div class="radial-node node-fire" data-element="Fire"
                            data-info="Visually pleasing and thoughtfully packaged, our products honor the element of fire and perception.">
                            <i class="fas fa-fire"></i>
                            <span>Fire</span>
                        </div>
                        <div class="radial-node node-water" data-element="Water"
                            data-info="Herbal infusions are carefully balanced to support wellness while remaining pleasant and harmonious.">
                            <i class="fas fa-tint"></i>
                            <span>Water</span>
                        </div>
                        <div class="radial-node node-earth" data-element="Earth"
                            data-info="With earthy, grounding fragrances inspired by nature after rain, our products embody the essence of earth.">
            ...
            <div class="dosha-grid">
                ...
                <div class="dosha-card" id="dosha-kapha">
                    ...
                    <p class="dosha-card-text">Kapha represents calm, soft, and cool energy, like the gentle nature of
                        earth. People with Kapha qualities are peaceful, caring, and graceful, with soft and cool skin. Warm
                        colors like red and purple suit them well. When out of balance, they may become overly attached or
                        possessive. To regain balance, activities like a warm sesame oil massage or listening to energetic
                ...
                <div class="dosha-card" id="dosha-pitta">
                    ...
                    <p class="dosha-card-text">Pitta represents fire energy — strong, intense, and powerful. People with
                        Pitta qualities are passionate, active, and focused. Cool colors like green and blue help calm and
                        balance them. When balanced, they are warm, joyful, and inspiring. When out of balance, they may
                        become angry or irritable. To restore balance, they should relax, take breaks, meditate, enjoy
                        calming scents like sandalwood, or take peaceful walks.</p>
                </div>
                <!-- Vatta -->
                <div class="dosha-card" id="dosha-vatta">
                    ...
                    <p class="dosha-card-text">Vata represents wind energy — light, active, and delicate. People with Vata
                        qualities often have thin, cool, and dry skin with gentle features. Warm colors suit them well, and
                        they look bright in green and gold. They feel emotions quickly and can be easily disturbed by harsh
                        sounds or behavior. Gentle touch and calming scents like jasmine or rose help them relax and stay
                        balanced.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="position: relative; z-index: 2; text-align: center;">
            ...
            <div class="cta-btns" style="margin-top: 50px;">
                <a href="{{ route('shop') }}" class="btn btn-primary"
                    style="background: #fff; color: #004200; padding: 18px 40px; font-size: 1.1rem;">Explore Collection</a>
                <a href="https://wa.me/919818299669" class="btn btn-outline"
                    style="border-color: #fff; color: #fff; margin-left: 25px; padding: 18px 40px;">Consult an Expert</a>
            </div>
        </div>
    </section>
@endsection
