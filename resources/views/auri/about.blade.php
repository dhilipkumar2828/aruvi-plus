...
@section('content')
    ...
    <section class="about-hero-sec">
        <div class="container hero-inner">
            ...
            <h1 class="sec-title">Authenticity &amp; Tradition</h1>
            <p class="p-text" style="margin: 0 auto; max-width: 900px;">Going way back to the ancient times, and infusing that wisdom to the present-day culture, is where we come from. Auvriplus is the best brand in the combination of authenticity and tradition to give the best products for Hair Care. Our foundations come from the ancient ayurvedic scriptures and science.</p>
        </div>
    </section>
