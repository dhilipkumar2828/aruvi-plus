                ...
                <section class="section-card" style="margin: 0 30px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        ...
                        <div class="field">
                            ...
                            <select id="state" name="state" required style="width: 100%; background: #fff; border: 1px solid #eee; border-radius: 12px; padding: 14px 18px; color: #333; font-family: inherit; font-size: 14px; transition: all 0.3s ease;">
