...
<div class="content-card">
    <div class="card-header">
        <div>
            ...
            <p style="margin: 6px 0 0; font-size: 13px; color: var(--text-muted);">Add a new client testimonial to showcase on the website.</p>
        </div>
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" style="padding: 40px;">
        @csrf
        
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 25px;">
            <div class="admin-form-group">
                <label class="admin-form-label">Client Name <span class="text-danger">*</span></label>
                <input type="text" name="name" value="{{ old('name') }}" required class="admin-input" placeholder="e.g. John Doe">
            ...
            <div class="admin-form-group">
                ...
                <input type="text" name="designation" value="{{ old('designation') }}" class="admin-input" placeholder="e.g. CEO, New York">
            ...
            <div class="admin-form-group" style="grid-column: span 2;">
                ...
                <textarea name="content" rows="6" class="admin-textarea" placeholder="Enter the client's testimonial here..." required>{{ old('content') }}</textarea>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 15px; margin-top: 20px; padding-top: 30px; border-top: 1px solid rgba(194, 24, 91, 0.1);">
            <button type="submit" class="admin-btn admin-btn-primary">
                <i class="fas fa-cloud-upload-alt"></i> Create Testimonial
            </button>
        </div>
    </form>
</div>
