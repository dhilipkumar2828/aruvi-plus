            ...
            <div class="policy-card animate-fade">
                ...
                <div class="policy-content">
                    ...
                    <p>An anonymized string created from your email address (also called a hash) may be provided to the
                        Gravatar service to see if you are using it. After approval of your comment, your profile picture is
                    ...
                    <p>If you have an account and you log in to this site, we will set a temporary cookie to determine if
