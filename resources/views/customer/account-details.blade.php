                        ...
                        <div class="luxury-tab-pane active" id="personal">
                            <form action="{{ route('customer.details.update') }}" method="POST" enctype="multipart/form-data" id="personalInfoForm" class="luxury-form">
                                ...
                                <div class="profile-upload-section">
                                    <div class="avatar-preview-container">
                                        @if($user->profile_image)
                                            <img id="preview-img" src="{{ asset($user->profile_image) }}" class="avatar-img">
                                        @else
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-luxury-submit">Save Personal Information</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form action="{{ route('customer.password.update') }}" method="POST" id="securityForm" class="luxury-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <i class="fas fa-eye toggle-visibility" onclick="togglePass('current_password', this)"></i>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="password" name="password" id="new_password" placeholder="Minimum 8 characters">
                                        <i class="fas fa-eye toggle-visibility" onclick="togglePass('new_password', this)"></i>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <i class="fas fa-eye toggle-visibility" onclick="togglePass('password_confirmation', this)"></i>
                                    </div>
                                </div>
...
.luxury-account-page {
    ...
    padding: 60px 0 100px; /* Reduced from 100px to avoid huge gap */
}
...
.luxury-tab-btn i { font-size: 20px; }

.luxury-tab-btn.active { color: var(--primary); }
...
/* Tab Panes */
.luxury-tab-pane { display: none; animation: fadeIn 0.4s ease; }
.luxury-tab-pane.active { display: block; }
...
.avatar-img { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; border: 3px solid #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
...
/* Forms */
.luxury-form { width: 100%; }
.luxury-form .form-row { display: flex; gap: 20px; margin-bottom: 5px; flex-wrap: wrap; }
.luxury-form .col-md-6 { flex: 1; min-width: calc(50% - 10px); }
.luxury-form .form-group { margin-bottom: 25px; }
.luxury-form label { display: block; margin-bottom: 10px; font-weight: 700; font-size: 14px; color: #333; }
.luxury-form label span { color: #d32f2f; }

.input-with-icon { position: relative; width: 100%; }
.input-with-icon i:first-child { position: absolute; left: 18px; top: 18px; color: var(--primary); font-size: 16px; transition: all 0.3s; }
...
.input-with-icon.no-icon input { padding-left: 20px; }

.input-with-icon input:focus { border-color: var(--primary); background: #fff; outline: none; box-shadow: 0 0 0 4px var(--luxury-green-soft); }
.input-with-icon input:focus + i { color: var(--primary); opacity: 1; }

.toggle-visibility { position: absolute; right: 18px; top: 18px; cursor: pointer; color: #aaa; font-size: 16px; transition: color 0.3s; }
.toggle-visibility:hover { color: var(--primary); }

.error-msg { color: #d32f2f; font-size: 12px; margin-top: 6px; font-weight: 600; display: block; }
...
.btn-luxury-submit:hover { transform: translateY(-3px); box-shadow: 0 15px 35px rgba(0, 66, 0, 0.3); background: #003300; }
...
.security-intro i { font-size: 24px; color: var(--primary); }
.security-intro p { margin: 0; font-size: 14px; line-height: 1.5; color: var(--primary); font-weight: 500; }

@media (max-width: 991px) {
    .account-grid { grid-template-columns: 1fr; }
    .premium-tabs { gap: 15px; overflow-x: auto; white-space: nowrap; padding-bottom: 5px; }
    .luxury-tab-btn { font-size: 14px; }
}

@media (max-width: 767px) {
    .luxury-form .col-md-6 { min-width: 100%; }
}
