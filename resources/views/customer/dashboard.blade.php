        ...
        <div class="container">
            ...
            <div class="dashboard-hero" style="margin-top: 60px">
                <div class="dashboard-hero-content">
                    ...
                    <p class="dashboard-intro">From your account dashboard you can view your recent orders, manage your
                ...
                <div class="account-main-content">
                    <div class="section-card">
                        <div class="section-header-flex">
                            ...
                            <a href="{{ route('customer.orders') }}" class="view-all-link">View All <i
